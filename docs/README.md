...
- [004 — Design methodology for code slides](todo/004_design_methodology_for_code_slides.md) (closed 2026-05-27 — all of §A critique / §B patterns / §C iconography / §D grid / §E type roles / §F reference corpus / §G design-language landed)
...
- [013 — Strip slide-level pattern prescription](todo/013_strip_slide_level_pattern_prescription.md) (closed 2026-05-28 — §5a role→pattern table removed + "rotation is not a goal" framing + Three-step selection w/ trigger-table Step 0 + bespoke proposal_dense source inlined as Example 0)
