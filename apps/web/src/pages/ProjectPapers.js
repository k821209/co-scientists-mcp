...
function buildMcpJson(pid, apiKey) {
        ...
        mcpServers: {
            co_scientist: {
                ...
                env: {
                    ...
                    GOOGLE_APPLICATION_CREDENTIALS: "${HOME}/.co-scientist/serviceAccount.json",
                },
            },
        },
    }, null, 2);
